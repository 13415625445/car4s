    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>车辆管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'item-add'}">新增车辆</li>
	         		<li data-options="attributes:{'url':'item-list'}">查询车辆</li>
			...
			<li>
				<span>预约信息管理</span>
				<ul>
					<li data-options="attributes:{'url':'order-list'}">查询预约信息</li>
				</ul>
			</li>
         </ul>
    </div>
